...
import { parseJsonObjectInput } from './json';
import { normalizeChatCompletion } from './output';
import type { AlephantVirtualKeyCredentials, ChatMessage, InputMode } from './types';
...
export async function executeChatCompletionNode(
